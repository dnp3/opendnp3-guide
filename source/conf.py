...
copyright = u'2014, Automatak LLC'
...
# of the sidebar.
html_logo = 'img/automatak_logo.png'
...
texinfo_documents = [
  ('index', 'opendnp3guide', u'Definitive Guide to opendnp3',
   u'Adam Crain', 'dnp3guide', 'One line description of project.',
   'Miscellaneous'),
]
...
pdf_documents = [
('index', u'OpenDNP3', u'OpenDNP3', r'Adam Crain\\Pablo Giudice'),
]
